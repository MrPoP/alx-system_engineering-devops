...
17-tree - Create a script that creates the directories tmp/ and tmp/u/ in the current directory. You are only allowed to use two spaces in your script, not more.
